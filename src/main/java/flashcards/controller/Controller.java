...
public abstract class Controller {
    ...
    private PreparedStatement getDecksFromDBStmt;
    private PreparedStatement getCardsInDeckStmt;
    ...
    private void setUpPreparedStatements() throws SQLException {
        ...
        getDecksFromDBStmt = CONNECTION.prepareStatement("SELECT deck_title FROM '" +
                escapeApostrophes(MENU_TABLE) + "';");
        getCardsInDeckStmt = CONNECTION.prepareStatement("SELECT * FROM '" + escapeApostrophes(CARDS_TABLE) +
                "'Where deck_id = (select id from menu where deck_title = ?);");
    }
...
//    }
    ...
    protected ResultSet getAllDecksFromDB() throws SQLException {
        return getDecksFromDBStmt.executeQuery();
    }
    ...
    private ResultSet getAllCardsInDeck(String deckToGet) throws SQLException {
        getCardsInDeckStmt.setString(1, deckToGet);
        return getCardsInDeckStmt.executeQuery();
    }
